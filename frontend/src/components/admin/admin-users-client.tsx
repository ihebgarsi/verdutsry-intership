...
export default function AdminUsersPage() {
  ...
  return (
    <div>
      ...
      <p className="mt-1 text-sm text-gray-600">Admin CRUD — Sprint 1 (mock API until FastAPI is ready)</p>

      <form onSubmit={handleSubmit} className="mt-6 grid gap-4 rounded-lg border bg-white p-6 sm:grid-cols-2">
        <Field label="Email">
          <input
            type="email"
            value={form.email}
              ...
              users.map((u) => (
                <tr key={u.id} className="border-b last:border-0">
                  ...
                  <td className="px-4 py-3">
                    <button type="button" className="mr-2 text-emerald-700 hover:underline" onClick={() => startEdit(u)}>
                      Edit
                    </button>
